                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FB7427]/10 border border-[#FB7427]/20">
                            ...
                            <span className="text-[10px] font-bold text-[#FB7427] uppercase tracking-[0.2em]">Pilot Logbook</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter">
                            Mission <span className="text-[#FB7427]">Proposals</span>
                        </h1>
                ...
                <div className="space-y-6">
                    {proposals.length === 0 ? (
                        <div className="p-20 text-center rounded-3xl border border-dashed border-white/10 bg-[#18222e]/50 space-y-6">
                            ...
                            <Link href="/jobs">
                                <Button className="bg-[#FB7427] text-[#0f1722] font-bold hover:bg-[#e8651a] transition-all">
                                    ...
                                    <div className="p-8 rounded-2xl bg-[#18222e] border border-white/5 hover:border-[#FB7427]/40 transition-all duration-300 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative overflow-hidden">
                                        <div className="space-y-4 relative z-10">
                                            ...
                                            <div className="flex items-center gap-4 text-[10px] font-bold text-gray-600 tracking-widest uppercase">
                                                <span className="flex items-center gap-1.5"><MapPin className="w-3 h-3 text-[#FB7427]" /> {proposal.job.location}</span>
                                                <span className="flex items-center gap-1.5"><Briefcase className="w-3 h-3 text-[#FB7427]" /> {proposal.job.category}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-8 w-full md:w-auto relative z-10">
                                            <div className="flex-1 md:flex-none p-4 rounded-xl bg-black/40 border border-white/5 text-center min-w-[140px]">
                                                <div className="text-2xl font-black text-white leading-none flex items-center justify-center gap-1">
                                                    <DollarSign className="w-4 h-4 text-[#FB7427]" /> {Number(proposal.price).toLocaleString()}
                                                </div>
