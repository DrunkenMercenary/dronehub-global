        ...
        <div className="min-h-screen bg-[#0f1722] py-16 md:py-24">
            <div className="container max-w-3xl px-4 md:px-6">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                    <a href="mailto:hello@dronehub.global" className="p-6 rounded-2xl bg-[#18222e] border border-white/5 hover:border-[#5BC2E7]/30 transition-all space-y-3 block">
                        <div className="w-11 h-11 rounded-xl bg-[#5BC2E7]/10 border border-[#5BC2E7]/20 flex items-center justify-center text-[#5BC2E7]"><Mail className="w-5 h-5" /></div>
                    ...
                    <div className="p-6 rounded-2xl bg-[#18222e] border border-white/5 space-y-3">
                        <div className="w-11 h-11 rounded-xl bg-[#FB7427]/10 border border-[#FB7427]/20 flex items-center justify-center text-[#FB7427]"><MessageSquare className="w-5 h-5" /></div>
