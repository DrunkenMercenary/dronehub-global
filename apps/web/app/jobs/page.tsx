            ...
            <div className="container px-4 md:px-6">
                ...
                <div className="max-w-4xl mb-16 space-y-6">
                    <div className="inline-block px-3 py-1 rounded-full bg-[#5BC2E7]/10 border border-[#5BC2E7]/20">
                        <span className="text-[#5BC2E7] text-[10px] font-bold tracking-[0.2em] uppercase">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-12">
                    <div className="relative flex-1">
                        ...
                        <Input
                            ...
                            className="w-full bg-[#18222e] border-white/5 h-14 pl-12 text-white placeholder:text-gray-600 focus:border-[#5BC2E7]/50 transition-all rounded-xl"
                        />
                    </div>
                    <Button size="lg" variant="outline" className="h-14 border-white/5 bg-[#18222e] text-white font-bold px-8 rounded-xl hover:bg-[#5BC2E7]/10 hover:border-[#5BC2E7]/30">
