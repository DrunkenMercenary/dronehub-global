            ...
            <div className="container flex h-20 items-center justify-between px-4 md:px-6">
                <div className="flex items-center gap-8">
                    <Link href="/" className="flex items-center space-x-3 group">
                        <div className="w-10 h-10 rounded-xl bg-[#5BC2E7]/10 flex items-center justify-center border border-[#5BC2E7]/20 group-hover:bg-[#5BC2E7]/20 transition-all duration-300 shadow-lg shadow-[#5BC2E7]/5">
                            <Drone className="w-6 h-6 text-[#5BC2E7]" />
                        </div>
                    ...
                    <nav className="hidden lg:flex items-center space-x-8 text-[11px] font-bold uppercase tracking-[0.2em] text-gray-500">
                        <Link href="/operators" className="transition-all hover:text-[#FB7427] flex items-center gap-2">
                            <Users className="w-3.5 h-3.5" /> Browse operators
                        </Link>
                        <Link href="/jobs" className="transition-all hover:text-[#5BC2E7] flex items-center gap-2">
                            <Search className="w-3.5 h-3.5" /> Find jobs
                        </Link>
                        <Link href="/regulations" className="transition-all hover:text-[#FB7427] flex items-center gap-2">
                            <Scale className="w-3.5 h-3.5" /> Regulations
                        </Link>
                        {!isLoggedIn && (
                            <Link href="/register/operator" className="transition-all hover:text-[#5BC2E7] flex items-center gap-2">
                                Become an operator
                            </Link>
                        )}
                        {isLoggedIn && (
                            <Link href={dashboardHref} className="transition-all hover:text-[#5BC2E7] flex items-center gap-2">
                ...
                <div className="flex items-center gap-4">
                    {!isLoggedIn ? (
                        <div className="hidden md:flex items-center gap-2">
                            ...
                            <Link href="/register">
                                <Button className="bg-[#5BC2E7] hover:bg-[#3aa9d4] text-[#0f1722] font-black uppercase tracking-tighter px-8 h-11 rounded-xl shadow-xl shadow-[#5BC2E7]/10 transition-all active:scale-95">
                                    Sign up
                                </Button>
                            </Link>
                        </div>
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <NotificationBell />
                            <Link href="/account" className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/5 border border-white/5 hover:border-[#5BC2E7]/30 transition-all">
                                <div className="w-8 h-8 rounded-lg bg-[#5BC2E7]/20 flex items-center justify-center text-[#5BC2E7] font-black text-sm uppercase">
                                    {userName.charAt(0)}
                                </div>
                            ...
                            <>
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <Link href="/register" className="flex-1">
                                        <Button className="w-full bg-[#5BC2E7] hover:bg-[#3aa9d4] text-[#0f1722] font-black" onClick={() => setMobileOpen(false)}>
                                            Sign up
                                        </Button>
                                    </Link>
                                </div>
                            ...
                            <>
                                ...
                                <div className="flex items-center justify-between pt-2 border-t border-white/5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-lg bg-[#5BC2E7]/20 flex items-center justify-center text-[#5BC2E7] font-black text-sm">
                                            {userName.charAt(0)}
                                        </div>
                                        <div>
