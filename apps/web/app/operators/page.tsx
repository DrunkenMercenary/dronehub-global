            ...
            <div className="container px-4 md:px-6">
                <div className="space-y-4 mb-12 max-w-2xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#5BC2E7]/10 border border-[#5BC2E7]/20">
                        <Users className="w-3.5 h-3.5 text-[#5BC2E7]" />
                        <span className="text-[10px] font-bold text-[#5BC2E7] uppercase tracking-[0.2em]">Verified operators</span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-none">
                        Browse <span className="text-[#5BC2E7]">drone operators</span>
                    </h1>
