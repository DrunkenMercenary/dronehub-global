            ...
            <div className="container px-4 md:px-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                    ...
                    <div className="flex gap-3">
                        <Link href="/client/saved">
                            <Button variant="outline" className="border-white/10 text-white font-bold h-14 px-6 rounded-xl hover:bg-[#FB7427] hover:text-[#0f1722] hover:border-[#FB7427] transition-all flex items-center gap-2">
                                <Heart className="w-5 h-5" /> Saved
                            </Button>
                        </Link>
                        <Link href="/jobs/new">
                            <Button className="bg-[#5BC2E7] hover:bg-[#3aa9d4] text-[#0f1722] font-black uppercase tracking-tighter h-14 px-8 rounded-xl shadow-xl shadow-[#5BC2E7]/10 transition-all active:scale-95 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    ...
                    <div className="p-6 rounded-2xl bg-[#18222e] border border-white/5 space-y-1">
                        ...
                        <p className="text-3xl font-black text-[#5BC2E7]">{totalBids}</p>
                    </div>
                    <div className="p-6 rounded-2xl bg-[#18222e] border border-white/5 space-y-1">
                            ...
                            {jobs.map((job: any) => (
                                <Link key={job.id} href={`/jobs/${job.id}`} className="group">
                                    <div className="p-8 rounded-2xl bg-[#18222e] border border-white/5 hover:border-[#5BC2E7]/40 transition-all duration-300 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative overflow-hidden">
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#5BC2E7]/5 blur-3xl rounded-full translate-x-16 -translate-y-16"></div>
                                        ...
                                        <div className="space-y-3 relative z-10">
                                            ...
                                            <div className="flex items-center gap-4 text-[10px] font-bold text-gray-600 tracking-widest uppercase">
                                                <span className="flex items-center gap-1.5"><MapPin className="w-3 h-3 text-[#5BC2E7]" /> {job.location}</span>
                                                <span className="flex items-center gap-1.5"><Briefcase className="w-3 h-3 text-[#5BC2E7]" /> {job.category}</span>
                                            </div>
                                        </div>
