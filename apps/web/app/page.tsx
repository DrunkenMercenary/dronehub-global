...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#0f1722] text-white">
        ...
        <div className="container px-4 md:px-6 relative z-10 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-block px-3 py-1 rounded-full bg-[#5BC2E7]/10 border border-[#5BC2E7]/20">
                <span className="text-[#5BC2E7] text-[10px] font-bold tracking-[0.2em] uppercase flex items-center gap-2">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#5BC2E7] opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-[#5BC2E7]"></span>
                  </span>
              ...
              <div className="space-y-6">
                <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[1.1]">
                  Find Expert <br />
                  <span className="text-[#5BC2E7]">Drone Operators</span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/register/client">
                  <Button size="lg" className="w-full sm:w-auto bg-[#5BC2E7] hover:bg-[#3aa9d4] text-[#0f1722] font-bold px-10 h-14 text-base rounded-lg transition-all shadow-lg shadow-[#5BC2E7]/20 border-none">
                    Get Started as Customer
                  </Button>
                </Link>
                <Link href="/register/operator">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-[#FB7427]/40 text-[#FB7427] hover:bg-[#FB7427]/10 hover:border-[#FB7427] font-bold px-10 h-14 text-base rounded-lg transition-all">
                    Join as Operator
                  </Button>
                </Link>
              </div>
            ...
            <div className="relative h-[400px] md:h-[500px] lg:h-[600px]">
              <div className="absolute inset-0 bg-[#5BC2E7]/10 rounded-full blur-[120px] opacity-30"></div>
          ...
          <div className="mt-20 flex flex-wrap gap-10 opacity-60">
            <div className="flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] text-white uppercase group hover:opacity-100 transition-opacity">
              <ShieldCheck className="w-4 h-4 text-[#FB7427]" />
              Certified Operators
            </div>
            <div className="flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] text-white uppercase group hover:opacity-100 transition-opacity">
              <CheckCircle className="w-4 h-4 text-[#5BC2E7]" />
              Trusted Platform
            </div>
            <div className="flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] text-white uppercase group hover:opacity-100 transition-opacity">
              <Globe className="w-4 h-4 text-[#FB7427]" />
              Global Network
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="group p-10 rounded-2xl bg-[#18222e] border border-white/5 hover:border-[#5BC2E7]/40 transition-all duration-500 text-center flex flex-col items-center"
              >
                <div className="w-16 h-16 rounded-[20px] bg-[#5BC2E7]/5 flex items-center justify-center mb-8 border border-[#5BC2E7]/10 group-hover:bg-[#5BC2E7]/10 transition-colors duration-500">
                  <service.icon className="w-8 h-8 text-[#5BC2E7] group-hover:scale-110 transition-transform duration-500" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4 group-hover:text-[#5BC2E7] transition-colors">{service.title}</h3>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-[20px] bg-[#FB7427]/5 flex items-center justify-center mb-8 border border-[#FB7427]/10">
                  <item.icon className="w-8 h-8 text-[#FB7427]" />
                </div>
      ...
      <section className="w-full py-24 bg-[#5BC2E7]">
        <div className="container px-4 md:px-6">
